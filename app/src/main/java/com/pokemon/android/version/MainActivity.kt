...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        val idForSVsprites = listOf(6, 25, 26, 39, 40, 48, 49, 52, 53, 54, 55, 56, 57, 58, 59, 79, 80, 81,
            ...
            297, 308, 373, 398, 405, 426, 429, 430, 442, 448, 453, 454, 461, 462, 470, 475, 488, 602, 603, 604,
            633, 634, 635, 700, 715, 856, 857, 858, 878, 879, 885, 886,887
            //,23,24,35,36,37,38,60,61,62,161,162,163,164,173,186,190,193,207,342,350,424,469,472,477
        )
    }
