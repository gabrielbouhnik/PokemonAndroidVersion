...
class RewardMenu {
    ...
    fun loadHallOfFameMenu(activity: MainActivity){
        ...
        activity.displayPokemon(activity.trainer!!.team[0].data.id, activity.trainer!!.team[0].shiny, activity.findViewById(R.id.pokemonHOFspriteView))
        if (activity.trainer!!.team.size > 1)
            activity.displayPokemon(activity.trainer!!.team[1].data.id, activity.trainer!!.team[1].shiny,activity.findViewById(R.id.pokemonHOFspriteView2))
        if (activity.trainer!!.team.size > 2)
            activity.displayPokemon(activity.trainer!!.team[2].data.id, activity.trainer!!.team[2].shiny,activity.findViewById(R.id.pokemonHOFspriteView3))
        if (activity.trainer!!.team.size > 3)
            activity.displayPokemon(activity.trainer!!.team[3].data.id, activity.trainer!!.team[3].shiny,activity.findViewById(R.id.pokemonHOFspriteView4))
        if (activity.trainer!!.team.size > 4)
            activity.displayPokemon(activity.trainer!!.team[4].data.id, activity.trainer!!.team[4].shiny,activity.findViewById(R.id.pokemonHOFspriteView5))
        if (activity.trainer!!.team.size > 5)
            activity.displayPokemon(activity.trainer!!.team[5].data.id, activity.trainer!!.team[5].shiny,activity.findViewById(R.id.pokemonHOFspriteView6))
