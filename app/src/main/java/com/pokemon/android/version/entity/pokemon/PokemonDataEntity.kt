...
data class PokemonDataEntity(
    ...
    val catchRate: Int, val evolutions: ArrayList<EvolutionEntity>,
    val expGaugeType: String, val abilities: List<String>, var megaEvolutionData: MegaEvolutionDataEntity?
)