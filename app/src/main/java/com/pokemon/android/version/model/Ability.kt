...
enum class Ability(var description: String) {
    ...
    ICE_BODY("The Pokémon gradually regains HP in a Snowstorm."),
    IMMUNITY("The immune system of the Pokémon prevents it from getting poisoned."),
    INFILTRATOR("Passes through the opposing Pokémon's barrier."),
    ...
    OBLIVIOUS("The Pokémon is oblivious, and that keeps it from falling for taunts."),
    ...
    SHIELD_DUST("This Pokémon's dust blocks the additional effects of attacks taken."),
    ...
    SNOW_WARNING("The Pokémon summons a Snowstorm when it enters a battle."),
    ...
    SOUL_HEART("Boosts its Sp. Atk stat every time a Pokémon faints."),
